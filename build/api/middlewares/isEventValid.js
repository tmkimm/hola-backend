...
exports.isEventValid = exports.checkEvent = void 0;
var express_validator_1 = require("express-validator");
var CustomError_1 = __importDefault(require("../../CustomError"));
var asyncErrorWrapper_1 = require("../../asyncErrorWrapper");
var eventList_1 = __importDefault(require("../../eventList"));
var checkEvent = [
    (0, express_validator_1.body)('title').isString().withMessage('"title" Invaild datatype(String)').optional({ nullable: true }),
    (0, express_validator_1.body)('content').isString().withMessage('"content" Invaild datatype(String)').optional({ nullable: true }),
    (0, express_validator_1.body)('onlineOrOffline')
        .isString()
        .withMessage('"onlineOrOffline" Invaild datatype(String)')
        .optional({ nullable: true }),
    (0, express_validator_1.body)('place').isString().withMessage('"place" Invaild datatype(String)').optional({ nullable: true }),
    ...
    (0, express_validator_1.body)('eventType')
        ...
        var req = _a.req;
        return eventList_1.default.indexOf(value) > -1;
    })
        .withMessage('Invaild event list'),
];
exports.checkEvent = checkEvent;
// Event 유효성 검증 미들웨어
var isEventValid = (0, asyncErrorWrapper_1.asyncErrorWrapper)(function (req, res, next) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    errors = _a.sent();
                    if (!errors.isEmpty()) {
                        throw new CustomError_1.default('ContentInvaildError', 400, errors.array()[0].msg);
                    }
                    next();
                    return [2 /*return*/];
            }
...
//# sourceMappingURL=isEventValid.js.map