...
exports.default = (function (app) {
    ...
    route.get('/', (0, asyncErrorWrapper_1.asyncErrorWrapper)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, offset, limit, sort, language, period, isClosed, PostServiceInstance, posts;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.query, offset = _a.offset, limit = _a.limit, sort = _a.sort, language = _a.language, period = _a.period, isClosed = _a.isClosed;
                    PostServiceInstance = new index_2.PostService(Post_1.Post, User_1.User, Notification_1.Notification);
                    return [4 /*yield*/, PostServiceInstance.findPost(offset, limit, sort, language, period, isClosed)];
                case 1:
                    posts = _b.sent();
