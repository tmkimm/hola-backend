...
var PostService = /** @class */ (function () {
    ...
    // 리팩토링필요
    // 메인 화면에서 글 리스트를 조회한다.
    PostService.prototype.findPost = function (offset, limit, sort, language, period, isClosed) {
        return __awaiter(this, void 0, void 0, function () {
            var posts, sortPosts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.postModel.findPost(offset, limit, sort, language, period, isClosed)];
                    case 1:
                        posts = _a.sent();
