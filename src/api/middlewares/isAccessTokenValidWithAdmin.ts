...
const isAccessTokenValidWithAdmin = asyncErrorWrapper(async function (req: Request, res: Response, next: NextFunction) {
  if (req.headers.authorization && req.headers.authorization.startsWith('Bearer')) {
    ...
    if (!decodedUser.idToken || decodedUser.idToken !== 'admin')
      throw new CustomError('UnAuthorizedError', 401, 'UnAuthorizedError');
...
export { isAccessTokenValidWithAdmin };
